...
# 7. Set MiniDLNA location to the root of the mounted USB
echo "7. Setting MiniDLNA location to the root of the mounted USB for P/V/A files..."
...
# 8. Update permissions so MiniDLNA and Transmission have access to Read & Write
echo "8. Updating permissions for MiniDLNA and Transmission..."
sudo addgroup media
...
# 9. Add cleanup schedule
echo "9. Adding cleanup schedule..."
read -p "Enter the cleanup schedule choice (1, 2, 3, or 4): " CLEANUP_CHOICE
...
# 10. Add auto reboot nightly
echo "10. Adding nightly reboot and MiniDLNA rescan schedules..."
...
# 11. Install and Configure Lighttpd
echo "11. Installing and configuring Lighttpd..."
...
# 12. Configure firewall for remote access (UFW)
echo "12. Configuring firewall for remote access..."
